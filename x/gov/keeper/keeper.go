...
func NewKeeper(
	...
	k := &Keeper{
		...
		SecretVotes: 		   	collections.NewMap(sb, types.SecretVotesKeyPrefix, "secret_votes", collections.PairKeyCodec(collections.Uint64Key, sdk.LengthPrefixedAddressKey(sdk.AccAddressKey)), codec.CollValue[v1.SecretVote](cdc)), // nolint: staticcheck // sdk.LengthPrefixedAddressKey is needed to retain state compatibility
