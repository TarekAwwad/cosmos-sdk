...
type MsgSecretVote struct {
	...
	Voter string `protobuf:"bytes,2,opt,name=voter,proto3" json:"voter,omitempty"`
	// option defines the vote option.
	CypherId string `protobuf:"bytes,3,opt,name=cypher_id,json=cypherId,proto3" json:"cypher_id"`
	// metadata is any arbitrary metadata attached to the Vote.
	Metadata string `protobuf:"bytes,4,opt,name=metadata,proto3" json:"metadata,omitempty"`
}

func (m *MsgSecretVote) Reset()         { *m = MsgSecretVote{} }
func (m *MsgSecretVote) String() string { return proto.CompactTextString(m) }
func (*MsgSecretVote) ProtoMessage()    {}
func (*MsgSecretVote) Descriptor() ([]byte, []int) {
	return fileDescriptor_9ff8f4a63b6fc9a9, []int{5}
}
func (m *MsgSecretVote) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgSecretVote) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgSecretVote.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgSecretVote) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgSecretVote.Merge(m, src)
}
func (m *MsgSecretVote) XXX_Size() int {
	return m.Size()
}
func (m *MsgSecretVote) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgSecretVote.DiscardUnknown(m)
}

var xxx_messageInfo_MsgSecretVote proto.InternalMessageInfo

func (m *MsgSecretVote) GetProposalId() uint64 {
	if m != nil {
		return m.ProposalId
	}
	return 0
...
func (m *MsgSecretVote) GetVoter() string {
	if m != nil {
		return m.Voter
	}
	return ""
...
func (m *MsgSecretVote) GetCypherId() string {
	if m != nil {
		return m.CypherId
	}
	return ""
...
func (m *MsgSecretVote) GetMetadata() string {
	if m != nil {
		return m.Metadata
	}
	return ""
...
type MsgSecretVoteResponse struct {
	...
	CypherId string `protobuf:"bytes,2,opt,name=cypher_id,json=cypherId,proto3" json:"cypher_id"`
...
func (m *MsgSecretVoteResponse) Reset()         { *m = MsgSecretVoteResponse{} }
func (m *MsgSecretVoteResponse) String() string { return proto.CompactTextString(m) }
...
func (m *MsgSecretVoteResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgSecretVoteResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgSecretVoteResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgSecretVoteResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgSecretVoteResponse.Merge(m, src)
}
func (m *MsgSecretVoteResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgSecretVoteResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgSecretVoteResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgSecretVoteResponse proto.InternalMessageInfo

func (m *MsgSecretVoteResponse) GetProposalId() uint64 {
	if m != nil {
		return m.ProposalId
	}
	return 0
...
func (m *MsgSecretVoteResponse) GetCypherId() string {
	if m != nil {
		return m.CypherId
	}
	return ""
...
func (m *MsgSecretVoteResponse) GetSecretVote() *SecretVote {
	if m != nil {
		return m.SecretVote
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MsgSecretVote)(nil), "cosmos.gov.v1.MsgSecretVote")
	proto.RegisterType((*MsgVoteResponse)(nil), "cosmos.gov.v1.MsgVoteResponse")
	proto.RegisterType((*MsgSecretVoteResponse)(nil), "cosmos.gov.v1.MsgSecretVoteResponse")
...
var fileDescriptor_9ff8f4a63b6fc9a9 = []byte{
	...
	,
}
...
func (c *msgClient) SecretVote(ctx context.Context, in *MsgSecretVote, opts ...grpc.CallOption) (*MsgSecretVoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.gov.v1.Msg/SecretVote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMsgServer) SecretVote(ctx context.Context, req *MsgSecretVote) (*MsgSecretVoteResponse, error) {
...
func _Msg_SecretVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.gov.v1.Msg/SecretVote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *MsgSecretVote) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgSecretVote) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgSecretVote) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.CypherId) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.CypherId)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Voter) > 0 {
...
func (m *MsgSecretVoteResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgSecretVoteResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgSecretVoteResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgSecretVote) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgSecretVoteResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgSecretVote) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgSecretVote: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgSecretVote: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *MsgSecretVoteResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgSecretVoteResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgSecretVoteResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
