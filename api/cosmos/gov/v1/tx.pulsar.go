...
var (
	md_MsgSecretVote             protoreflect.MessageDescriptor
	fd_MsgSecretVote_proposal_id protoreflect.FieldDescriptor
	fd_MsgSecretVote_voter       protoreflect.FieldDescriptor
	fd_MsgSecretVote_cypher_id   protoreflect.FieldDescriptor
	fd_MsgSecretVote_metadata    protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_gov_v1_tx_proto_init()
	md_MsgSecretVote = File_cosmos_gov_v1_tx_proto.Messages().ByName("MsgSecretVote")
	fd_MsgSecretVote_proposal_id = md_MsgSecretVote.Fields().ByName("proposal_id")
	fd_MsgSecretVote_voter = md_MsgSecretVote.Fields().ByName("voter")
	fd_MsgSecretVote_cypher_id = md_MsgSecretVote.Fields().ByName("cypher_id")
	fd_MsgSecretVote_metadata = md_MsgSecretVote.Fields().ByName("metadata")
}

var _ protoreflect.Message = (*fastReflection_MsgSecretVote)(nil)

type fastReflection_MsgSecretVote MsgSecretVote

func (x *MsgSecretVote) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgSecretVote)(x)
}

func (x *MsgSecretVote) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_MsgSecretVote_messageType fastReflection_MsgSecretVote_messageType
var _ protoreflect.MessageType = fastReflection_MsgSecretVote_messageType{}

type fastReflection_MsgSecretVote_messageType struct{}

func (x fastReflection_MsgSecretVote_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgSecretVote)(nil)
}
func (x fastReflection_MsgSecretVote_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgSecretVote)
}
func (x fastReflection_MsgSecretVote_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgSecretVote
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgSecretVote) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgSecretVote
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgSecretVote) Type() protoreflect.MessageType {
	return _fastReflection_MsgSecretVote_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgSecretVote) New() protoreflect.Message {
	return new(fastReflection_MsgSecretVote)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgSecretVote) Interface() protoreflect.ProtoMessage {
	return (*MsgSecretVote)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgSecretVote) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ProposalId != uint64(0) {
		value := protoreflect.ValueOfUint64(x.ProposalId)
		if !f(fd_MsgSecretVote_proposal_id, value) {
			return
		}
	}
	if x.Voter != "" {
		value := protoreflect.ValueOfString(x.Voter)
		if !f(fd_MsgSecretVote_voter, value) {
			return
		}
	}
	if x.CypherId != "" {
		value := protoreflect.ValueOfString(x.CypherId)
		if !f(fd_MsgSecretVote_cypher_id, value) {
			return
		}
	}
	if x.Metadata != "" {
		value := protoreflect.ValueOfString(x.Metadata)
		if !f(fd_MsgSecretVote_metadata, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgSecretVote) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgSecretVote.proposal_id":
		return x.ProposalId != uint64(0)
	case "cosmos.gov.v1.MsgSecretVote.voter":
		return x.Voter != ""
	case "cosmos.gov.v1.MsgSecretVote.cypher_id":
		return x.CypherId != ""
	case "cosmos.gov.v1.MsgSecretVote.metadata":
		return x.Metadata != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgSecretVote"))
		}
		panic(fmt.Errorf("message cosmos.gov.v1.MsgSecretVote does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSecretVote) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgSecretVote.proposal_id":
		x.ProposalId = uint64(0)
	case "cosmos.gov.v1.MsgSecretVote.voter":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgSecretVote) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.gov.v1.MsgSecretVote.proposal_id":
		value := x.ProposalId
		return protoreflect.ValueOfUint64(value)
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.gov.v1.MsgSecretVote does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSecretVote) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgSecretVote.proposal_id":
		x.ProposalId = value.Uint()
	case "cosmos.gov.v1.MsgSecretVote.voter":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSecretVote) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgSecretVote.proposal_id":
		panic(fmt.Errorf("field proposal_id of message cosmos.gov.v1.MsgSecretVote is not mutable"))
	case "cosmos.gov.v1.MsgSecretVote.voter":
		panic(fmt.Errorf("field voter of message cosmos.gov.v1.MsgSecretVote is not mutable"))
	case "cosmos.gov.v1.MsgSecretVote.cypher_id":
		panic(fmt.Errorf("field cypher_id of message cosmos.gov.v1.MsgSecretVote is not mutable"))
	case "cosmos.gov.v1.MsgSecretVote.metadata":
		panic(fmt.Errorf("field metadata of message cosmos.gov.v1.MsgSecretVote is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgSecretVote"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgSecretVote) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgSecretVote.proposal_id":
		return protoreflect.ValueOfUint64(uint64(0))
	case "cosmos.gov.v1.MsgSecretVote.voter":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgSecretVote) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.gov.v1.MsgSecretVote", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgSecretVote) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSecretVote) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgSecretVote) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgSecretVote) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgSecretVote)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgSecretVote: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgSecretVote: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
var (
	md_MsgSecretVoteResponse             protoreflect.MessageDescriptor
	fd_MsgSecretVoteResponse_proposal_id protoreflect.FieldDescriptor
	fd_MsgSecretVoteResponse_cypher_id   protoreflect.FieldDescriptor
	fd_MsgSecretVoteResponse_secret_vote protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_gov_v1_tx_proto_init()
	md_MsgSecretVoteResponse = File_cosmos_gov_v1_tx_proto.Messages().ByName("MsgSecretVoteResponse")
	fd_MsgSecretVoteResponse_proposal_id = md_MsgSecretVoteResponse.Fields().ByName("proposal_id")
	fd_MsgSecretVoteResponse_cypher_id = md_MsgSecretVoteResponse.Fields().ByName("cypher_id")
	fd_MsgSecretVoteResponse_secret_vote = md_MsgSecretVoteResponse.Fields().ByName("secret_vote")
}

var _ protoreflect.Message = (*fastReflection_MsgSecretVoteResponse)(nil)

type fastReflection_MsgSecretVoteResponse MsgSecretVoteResponse

func (x *MsgSecretVoteResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgSecretVoteResponse)(x)
}

func (x *MsgSecretVoteResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_MsgSecretVoteResponse_messageType fastReflection_MsgSecretVoteResponse_messageType
var _ protoreflect.MessageType = fastReflection_MsgSecretVoteResponse_messageType{}

type fastReflection_MsgSecretVoteResponse_messageType struct{}

func (x fastReflection_MsgSecretVoteResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgSecretVoteResponse)(nil)
}
func (x fastReflection_MsgSecretVoteResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgSecretVoteResponse)
}
func (x fastReflection_MsgSecretVoteResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgSecretVoteResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgSecretVoteResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgSecretVoteResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgSecretVoteResponse) Type() protoreflect.MessageType {
	return _fastReflection_MsgSecretVoteResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgSecretVoteResponse) New() protoreflect.Message {
	return new(fastReflection_MsgSecretVoteResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgSecretVoteResponse) Interface() protoreflect.ProtoMessage {
	return (*MsgSecretVoteResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgSecretVoteResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ProposalId != uint64(0) {
		value := protoreflect.ValueOfUint64(x.ProposalId)
		if !f(fd_MsgSecretVoteResponse_proposal_id, value) {
			return
		}
	}
	if x.CypherId != "" {
		value := protoreflect.ValueOfString(x.CypherId)
		if !f(fd_MsgSecretVoteResponse_cypher_id, value) {
			return
		}
	}
	if x.SecretVote != nil {
		value := protoreflect.ValueOfMessage(x.SecretVote.ProtoReflect())
		if !f(fd_MsgSecretVoteResponse_secret_vote, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgSecretVoteResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgSecretVoteResponse.proposal_id":
		return x.ProposalId != uint64(0)
	case "cosmos.gov.v1.MsgSecretVoteResponse.cypher_id":
		return x.CypherId != ""
	case "cosmos.gov.v1.MsgSecretVoteResponse.secret_vote":
		return x.SecretVote != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgSecretVoteResponse"))
		}
		panic(fmt.Errorf("message cosmos.gov.v1.MsgSecretVoteResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSecretVoteResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgSecretVoteResponse.proposal_id":
		x.ProposalId = uint64(0)
	case "cosmos.gov.v1.MsgSecretVoteResponse.cypher_id":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgSecretVoteResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.gov.v1.MsgSecretVoteResponse.proposal_id":
		value := x.ProposalId
		return protoreflect.ValueOfUint64(value)
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.gov.v1.MsgSecretVoteResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSecretVoteResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgSecretVoteResponse.proposal_id":
		x.ProposalId = value.Uint()
	case "cosmos.gov.v1.MsgSecretVoteResponse.cypher_id":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSecretVoteResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgSecretVoteResponse.secret_vote":
		if x.SecretVote == nil {
	...
	case "cosmos.gov.v1.MsgSecretVoteResponse.proposal_id":
		panic(fmt.Errorf("field proposal_id of message cosmos.gov.v1.MsgSecretVoteResponse is not mutable"))
	case "cosmos.gov.v1.MsgSecretVoteResponse.cypher_id":
		panic(fmt.Errorf("field cypher_id of message cosmos.gov.v1.MsgSecretVoteResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgSecretVoteResponse"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgSecretVoteResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgSecretVoteResponse.proposal_id":
		return protoreflect.ValueOfUint64(uint64(0))
	case "cosmos.gov.v1.MsgSecretVoteResponse.cypher_id":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgSecretVoteResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.gov.v1.MsgSecretVoteResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgSecretVoteResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgSecretVoteResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgSecretVoteResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgSecretVoteResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgSecretVoteResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgSecretVoteResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgSecretVoteResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
// MsgSecretVote defines a message to cast a vote with secret ballot.
type MsgSecretVote struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MsgSecretVote) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgSecretVote) ProtoMessage() {}

// Deprecated: Use MsgSecretVote.ProtoReflect.Descriptor instead.
func (*MsgSecretVote) Descriptor() ([]byte, []int) {
	return file_cosmos_gov_v1_tx_proto_rawDescGZIP(), []int{5}
}

func (x *MsgSecretVote) GetProposalId() uint64 {
	if x != nil {
		return x.ProposalId
	}
	return 0
...
func (x *MsgSecretVote) GetVoter() string {
	if x != nil {
		return x.Voter
	}
	return ""
...
func (x *MsgSecretVote) GetCypherId() string {
	if x != nil {
		return x.CypherId
	}
	return ""
...
func (x *MsgSecretVote) GetMetadata() string {
	if x != nil {
		return x.Metadata
	}
	return ""
...
// MsgSecretVoteResponse defines the Msg/SecretVote response type.
type MsgSecretVoteResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	CypherId string `protobuf:"bytes,2,opt,name=cypher_id,json=cypherId,proto3" json:"cypher_id,omitempty"`
	// secret_vote defines the secret vote.
	SecretVote *SecretVote `protobuf:"bytes,3,opt,name=secret_vote,json=secretVote,proto3" json:"secret_vote,omitempty"`
}

func (x *MsgSecretVoteResponse) Reset() {
	*x = MsgSecretVoteResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_gov_v1_tx_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *MsgSecretVoteResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgSecretVoteResponse) ProtoMessage() {}

// Deprecated: Use MsgSecretVoteResponse.ProtoReflect.Descriptor instead.
func (*MsgSecretVoteResponse) Descriptor() ([]byte, []int) {
	return file_cosmos_gov_v1_tx_proto_rawDescGZIP(), []int{7}
}

func (x *MsgSecretVoteResponse) GetProposalId() uint64 {
	if x != nil {
		return x.ProposalId
	}
	return 0
...
func (x *MsgSecretVoteResponse) GetCypherId() string {
	if x != nil {
		return x.CypherId
	}
	return ""
...
func (x *MsgSecretVoteResponse) GetSecretVote() *SecretVote {
	if x != nil {
		return x.SecretVote
	}
	return nil
...
var file_cosmos_gov_v1_tx_proto_rawDesc = []byte{
	...
	0x67, 0x56, 0x6f, 0x74, 0x65, 0x22, 0xea, 0x01, 0x0a, 0x0d, 0x4d, 0x73, 0x67, 0x53, 0x65, 0x63,
	0x72, 0x65, 0x74, 0x56, 0x6f, 0x74, 0x65, 0x12, 0x35, 0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x70, 0x6f,
	...
	,
	...
	0x64, 0x12, 0x2a, 0x0a, 0x09, 0x63, 0x79, 0x70, 0x68, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x0d, 0xea, 0xde, 0x1f, 0x09, 0x63, 0x79, 0x70, 0x68, 0x65, 0x72,
	0x5f, 0x69, 0x64, 0x52, 0x08, 0x63, 0x79, 0x70, 0x68, 0x65, 0x72, 0x49, 0x64, 0x12, 0x3a, 0x0a,
	0x0b, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x5f, 0x76, 0x6f, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x67, 0x6f, 0x76, 0x2e,
	0x76, 0x31, 0x2e, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x56, 0x6f, 0x74, 0x65, 0x52, 0x0a, 0x73,
	0x65, 0x63, 0x72, 0x65, 0x74, 0x56, 0x6f, 0x74, 0x65, 0x22, 0xff, 0x01, 0x0a, 0x0f, 0x4d, 0x73,
	...
	0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x67,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x3a, 0x2c, 0x82,
	0xe7, 0xb0, 0x2a, 0x05, 0x76, 0x6f, 0x74, 0x65, 0x72, 0x8a, 0xe7, 0xb0, 0x2a, 0x1d, 0x63, 0x6f,
	0x73, 0x6d, 0x6f, 0x73, 0x2d, 0x73, 0x64, 0x6b, 0x2f, 0x76, 0x31, 0x2f, 0x4d, 0x73, 0x67, 0x56,
	0x6f, 0x74, 0x65, 0x57, 0x65, 0x69, 0x67, 0x68, 0x74, 0x65, 0x64, 0x22, 0x19, 0x0a, 0x17, 0x4d,
	0x73, 0x67, 0x56, 0x6f, 0x74, 0x65, 0x57, 0x65, 0x69, 0x67, 0x68, 0x74, 0x65, 0x64, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xe6, 0x01, 0x0a, 0x0a, 0x4d, 0x73, 0x67, 0x44, 0x65,
	0x70, 0x6f, 0x73, 0x69, 0x74, 0x12, 0x35, 0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61,
	...
	0x69, 0x74, 0x6f, 0x72, 0x12, 0x3c, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03,
	...
	0x6e, 0x74, 0x3a, 0x2b, 0x82, 0xe7, 0xb0, 0x2a, 0x09, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74,
	0x6f, 0x72, 0x8a, 0xe7, 0xb0, 0x2a, 0x18, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2d, 0x73, 0x64,
	0x6b, 0x2f, 0x76, 0x31, 0x2f, 0x4d, 0x73, 0x67, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x22,
	...
	0xb0, 0x2a, 0x01, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x3a, 0x36, 0x82, 0xe7, 0xb0,
	...
	,
	...
	,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5c, 0x0a, 0x0e, 0x43, 0x61, 0x6e, 0x63, 0x65,
	0x6c, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x12, 0x20, 0x2e, 0x63, 0x6f, 0x73, 0x6d,
	0x6f, 0x73, 0x2e, 0x67, 0x6f, 0x76, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x73, 0x67, 0x43, 0x61, 0x6e,
	0x63, 0x65, 0x6c, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x1a, 0x28, 0x2e, 0x63, 0x6f,
	0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x67, 0x6f, 0x76, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x73, 0x67, 0x43,
	0x61, 0x6e, 0x63, 0x65, 0x6c, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x1a, 0x05, 0x80, 0xe7, 0xb0, 0x2a, 0x01, 0x42, 0x98, 0x01, 0x0a,
...
var file_cosmos_gov_v1_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_cosmos_gov_v1_tx_proto_goTypes = []interface{}{
	...
	(*MsgSecretVote)(nil),                // 5: cosmos.gov.v1.MsgSecretVote
	(*MsgVoteResponse)(nil),              // 6: cosmos.gov.v1.MsgVoteResponse
	(*MsgSecretVoteResponse)(nil),        // 7: cosmos.gov.v1.MsgSecretVoteResponse
	...
	(*MsgCancelProposal)(nil),            // 14: cosmos.gov.v1.MsgCancelProposal
	(*MsgCancelProposalResponse)(nil),    // 15: cosmos.gov.v1.MsgCancelProposalResponse
	(*anypb.Any)(nil),                    // 16: google.protobuf.Any
	(*v1beta1.Coin)(nil),                 // 17: cosmos.base.v1beta1.Coin
	(VoteOption)(0),                      // 18: cosmos.gov.v1.VoteOption
	(*SecretVote)(nil),                   // 19: cosmos.gov.v1.SecretVote
	(*WeightedVoteOption)(nil),           // 20: cosmos.gov.v1.WeightedVoteOption
	(*Params)(nil),                       // 21: cosmos.gov.v1.Params
	(*timestamppb.Timestamp)(nil),        // 22: google.protobuf.Timestamp
}
var file_cosmos_gov_v1_tx_proto_depIdxs = []int32{
	16, // 0: cosmos.gov.v1.MsgSubmitProposal.messages:type_name -> google.protobuf.Any
	17, // 1: cosmos.gov.v1.MsgSubmitProposal.initial_deposit:type_name -> cosmos.base.v1beta1.Coin
	16, // 2: cosmos.gov.v1.MsgExecLegacyContent.content:type_name -> google.protobuf.Any
	18, // 3: cosmos.gov.v1.MsgVote.option:type_name -> cosmos.gov.v1.VoteOption
	19, // 4: cosmos.gov.v1.MsgSecretVoteResponse.secret_vote:type_name -> cosmos.gov.v1.SecretVote
	20, // 5: cosmos.gov.v1.MsgVoteWeighted.options:type_name -> cosmos.gov.v1.WeightedVoteOption
	17, // 6: cosmos.gov.v1.MsgDeposit.amount:type_name -> cosmos.base.v1beta1.Coin
	21, // 7: cosmos.gov.v1.MsgUpdateParams.params:type_name -> cosmos.gov.v1.Params
	22, // 8: cosmos.gov.v1.MsgCancelProposalResponse.canceled_time:type_name -> google.protobuf.Timestamp
	0,  // 9: cosmos.gov.v1.Msg.SubmitProposal:input_type -> cosmos.gov.v1.MsgSubmitProposal
	2,  // 10: cosmos.gov.v1.Msg.ExecLegacyContent:input_type -> cosmos.gov.v1.MsgExecLegacyContent
	4,  // 11: cosmos.gov.v1.Msg.Vote:input_type -> cosmos.gov.v1.MsgVote
	5,  // 12: cosmos.gov.v1.Msg.SecretVote:input_type -> cosmos.gov.v1.MsgSecretVote
	8,  // 13: cosmos.gov.v1.Msg.VoteWeighted:input_type -> cosmos.gov.v1.MsgVoteWeighted
	10, // 14: cosmos.gov.v1.Msg.Deposit:input_type -> cosmos.gov.v1.MsgDeposit
	12, // 15: cosmos.gov.v1.Msg.UpdateParams:input_type -> cosmos.gov.v1.MsgUpdateParams
	14, // 16: cosmos.gov.v1.Msg.CancelProposal:input_type -> cosmos.gov.v1.MsgCancelProposal
	1,  // 17: cosmos.gov.v1.Msg.SubmitProposal:output_type -> cosmos.gov.v1.MsgSubmitProposalResponse
	3,  // 18: cosmos.gov.v1.Msg.ExecLegacyContent:output_type -> cosmos.gov.v1.MsgExecLegacyContentResponse
	6,  // 19: cosmos.gov.v1.Msg.Vote:output_type -> cosmos.gov.v1.MsgVoteResponse
	7,  // 20: cosmos.gov.v1.Msg.SecretVote:output_type -> cosmos.gov.v1.MsgSecretVoteResponse
	9,  // 21: cosmos.gov.v1.Msg.VoteWeighted:output_type -> cosmos.gov.v1.MsgVoteWeightedResponse
	11, // 22: cosmos.gov.v1.Msg.Deposit:output_type -> cosmos.gov.v1.MsgDepositResponse
	13, // 23: cosmos.gov.v1.Msg.UpdateParams:output_type -> cosmos.gov.v1.MsgUpdateParamsResponse
	15, // 24: cosmos.gov.v1.Msg.CancelProposal:output_type -> cosmos.gov.v1.MsgCancelProposalResponse
...
func file_cosmos_gov_v1_tx_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_gov_v1_tx_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgSecretVoteResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
